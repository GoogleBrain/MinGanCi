...
var o=D[e],i=g.attr(o,"data-showed");
if("no"==i){
...
e>=40&&!K?(window.topbarEnable||(document.title=window.title),K=!0,window.show_top_bar&&window.user_name&&window.topbarEnable&&(b.invoke("currentMpInfoShow",function(){}),
_({
...
dataType:"json",
async:!0
}))):40>e&&K&&(window.topbarEnable||(document.title=""),K=!1,window.show_top_bar&&window.user_name&&window.topbarEnable&&(b.invoke("currentMpInfoHide",function(){}),
_({
url:"/mp/appmsgreport?action=topbarevent",
data:{
__biz:biz,
...
source_logo_url:"",
is_ad:1
},P=g.attr(D[L],"data-templateid");
"list"==P?D[L].innerHTML=r.tmpl(p,W):"banner"==P?D[L].innerHTML=r.tmpl(s,W):"card"==P&&(D[L].innerHTML=r.tmpl(d,W));
}
}catch(H){
console.log(H);
}
...
l&&44206!=i&&(_||u)?(o=$.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=$.addParam(o,"tp","webp",!0),
...
-1==e.err_msg.indexOf("ok")&&(location.href=pt);
})):location.href=pt,!1)):!1:!1;
});
}
}catch(H){}
var ct=e("appmsg/outer_link.js");
if(new ct({
